...
@Component({
  selector: 'brx-spartacus-order-confirmation-totals',
  templateUrl: './spartacus-order-confirmation-totals.component.html',
})
export class SpartacusOrderConfirmationTotalsComponent implements OnInit {
